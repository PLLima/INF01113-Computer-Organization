        ...
        \begin{columns}
            \begin{column}{0.5\textwidth}
                ...
                \begin{tikzpicture}[scale=0.7]
                    \pgfplotsset{
                        every axis legend/.append style={ at={(0.5,0.35)}, anchor=center,legend columns = 1},
                    }
                    \begin{axis}[
                        title={IPC},
                        ...
                        {CacheSize_IPC.csv};
                        \addlegendentry{\textit{Binary Search}};
                        ...
                        \addplot table[
                            ...
                            x=size,
                            y expr={(\thisrow{bubblesort}+\thisrow{fft}+\thisrow{binary-search})/3}
                        ]
                        {CacheSize_IPC.csv};
            ...
            \begin{column}{0.5\textwidth}
                ...
                \begin{tikzpicture}[scale=0.7]
                    \pgfplotsset{
                        every axis legend/.append style={ at={(0.5,0.2)}, anchor=center,legend columns = 1},
                    }
                    \begin{axis}[
                        ...
                        \addplot table[
                            ...
                            mark=circle,
                            x=size,
                            y expr={\thisrow{binary-search}*1000}
                        ]
                        {CacheSize_time.csv};
                        \addlegendentry{\textit{Binary Search}};
                        ...
                        \addplot table[
                            ...
                            style=densely dashed,
                            x=size,
                            y expr={1000*(\thisrow{bubblesort}+\thisrow{fft}+\thisrow{binary-search})/3}
                        ]
                        {CacheSize_time.csv};
                        \addlegendentry{Média};
                    \end{axis}
